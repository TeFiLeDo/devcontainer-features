...
echo downloading: https://github.com/cargo-bins/cargo-quickinstall/releases/download/sqlx-cli-$VERSION-x86_64-unknown-linux-gnu/sqlx-cli-$VERSION-x86_64-unknown-linux-gnu.tar.gz
